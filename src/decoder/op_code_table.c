...
struct op_code_mapping op_code_table[] = {
    ...
    /* 40 */ {INC,       Gw, Xx, Xx, decode_instruction_no_mod_rm},
    /* 41 */ {INC,       Gw, Xx, Xx, decode_instruction_no_mod_rm},
    /* 42 */ {INC,       Gw, Xx, Xx, decode_instruction_no_mod_rm},
    /* 43 */ {INC,       Gw, Xx, Xx, decode_instruction_no_mod_rm},
    /* 44 */ {INC,       Gw, Xx, Xx, decode_instruction_no_mod_rm},
    /* 45 */ {INC,       Gw, Xx, Xx, decode_instruction_no_mod_rm},
    /* 46 */ {INC,       Gw, Xx, Xx, decode_instruction_no_mod_rm},
    /* 47 */ {INC,       Gw, Xx, Xx, decode_instruction_no_mod_rm},
    /* 48 */ {DEC,       Gw, Xx, Xx, decode_instruction_no_mod_rm},
    /* 49 */ {DEC,       Gw, Xx, Xx, decode_instruction_no_mod_rm},
    /* 4a */ {DEC,       Gw, Xx, Xx, decode_instruction_no_mod_rm},
    /* 4b */ {DEC,       Gw, Xx, Xx, decode_instruction_no_mod_rm},
    /* 4c */ {DEC,       Gw, Xx, Xx, decode_instruction_no_mod_rm},
    /* 4d */ {DEC,       Gw, Xx, Xx, decode_instruction_no_mod_rm},
    /* 4e */ {DEC,       Gw, Xx, Xx, decode_instruction_no_mod_rm},
    /* 4f */ {DEC,       Gw, Xx, Xx, decode_instruction_no_mod_rm},
    ...
    /* b0 */ {MOV,       Gb, Ib, Xx, decode_instruction_no_mod_rm},
    /* b1 */ {MOV,       Gb, Ib, Xx, decode_instruction_no_mod_rm},
    /* b2 */ {MOV,       Gb, Ib, Xx, decode_instruction_no_mod_rm},
    /* b3 */ {MOV,       Gb, Ib, Xx, decode_instruction_no_mod_rm},
    /* b4 */ {MOV,       Gb, Ib, Xx, decode_instruction_no_mod_rm},
    /* b5 */ {MOV,       Gb, Ib, Xx, decode_instruction_no_mod_rm},
    /* b6 */ {MOV,       Gb, Ib, Xx, decode_instruction_no_mod_rm},
    /* b7 */ {MOV,       Gb, Ib, Xx, decode_instruction_no_mod_rm},
    /* b8 */ {MOV,       Gw, Iw, Xx, decode_instruction_no_mod_rm},
    /* b9 */ {MOV,       Gw, Iw, Xx, decode_instruction_no_mod_rm},
    /* ba */ {MOV,       Gw, Iw, Xx, decode_instruction_no_mod_rm},
    /* bb */ {MOV,       Gw, Iw, Xx, decode_instruction_no_mod_rm},
    /* bc */ {MOV,       Gw, Iw, Xx, decode_instruction_no_mod_rm},
    /* bd */ {MOV,       Gw, Iw, Xx, decode_instruction_no_mod_rm},
    /* be */ {MOV,       Gw, Iw, Xx, decode_instruction_no_mod_rm},
    /* bf */ {MOV,       Gw, Iw, Xx, decode_instruction_no_mod_rm},
